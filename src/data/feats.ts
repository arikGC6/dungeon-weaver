...
export const FEATS: Feat[] = [
  ...
  { id: "shield_training", name: "Shield Training", nameHe: "אימון מגן",
    ...
    description: "+1 STR/DEX/CON (לבחירתך). Proficiency במגנים. שימוש בקסם עם מגן ביד." },

  // ===== Fifth Edition Feats (Total Party Kill Games) — מהחוברת שהעלית =====
  { id: "tpk_acrobatic", name: "Acrobatic", nameHe: "אקרובט", source: "Fifth Edition Feats",
    prerequisite: "DEX 13+, בקיאות באקרובטיקה", requirements: { minAbility: { dex: 13 } },
    abilityChoice: { options: ["str", "dex"] },
    description: "+1 STR או DEX (לבחירתך) · Expertise באקרובטיקה · קימה מ-prone עולה 5ft בלבד · פעם ל-short rest advantage על תמרון מבוסס DEX." },
  { id: "tpk_acrobatic_steps", name: "Acrobatic Steps", nameHe: "צעדים אקרובטיים", source: "Fifth Edition Feats",
    prerequisite: "DEX 13+, בקיאות באקרובטיקה", requirements: { minAbility: { dex: 13 } },
    description: "+1 DEX · חצי מהתנועה שלך בשטח קשה נחשב שטח רגיל · פעם ל-short rest התעלמות מוחלטת מהאטת שטח קשה.",
    bonuses: { ability: [{ ability: "dex", amount: 1 }] } },
  { id: "tpk_alertness", name: "Alertness", nameHe: "עירנות", source: "Fifth Edition Feats",
    prerequisite: "בקיאות בתפיסה",
    description: "+2 ליוזמה · אינך מופתע (אלא אם מסונוור/מחוסר הכרה) · אויבים לא מקבלים advantage בהתקפה מהתגנבות עליך.",
    bonuses: { initiative: 2 } },
  { id: "tpk_alignment_channel", name: "Alignment Channel", nameHe: "תיעול נטייה", source: "Fifth Edition Feats",
    prerequisite: "Channel Divinity",
    description: "+1 WIS · אפשר להשתמש ב-Channel Divinity כדי להבריח יצורים מנטייה מנוגדת (חוק/כאוס, טוב/רע).",
    bonuses: { ability: [{ ability: "wis", amount: 1 }] } },
  { id: "tpk_arcane_shield", name: "Arcane Shield", nameHe: "מגן ארקאני", source: "Fifth Edition Feats",
    prerequisite: "יכולת להטיל כישופים ארקאניים", requirements: { spellcasting: true },
    description: "Reaction — הקרב spell slot מרמה 1+ וקבל בונוס AC בגובה רמת ה-slot למשך דקה (לא קנטריפים)." },
  { id: "tpk_arcane_strike", name: "Arcane Strike", nameHe: "מכה ארקאנית", source: "Fifth Edition Feats",
    prerequisite: "יכולת להטיל כישופים ארקאניים", requirements: { spellcasting: true },
    description: "הנשקים שאתה אוחז נחשבים קסומים ומקבלים +1 להתקפה ולנזק כל עוד אתה אוחז בהם.",
    bonuses: {} },
  { id: "tpk_backstab", name: "Backstab", nameHe: "דקירה בגב", source: "Fifth Edition Feats",
    prerequisite: "בקיאות בהתגנבות + Sneak Attack",
    description: "נגד יעד שאינו מודע לך — טווח הקריט שלך גדל ב-1, ובקריט אתה מוסיף נזק בגובה קוביות ה-Sneak Attack." },
  { id: "tpk_blind_fight", name: "Blind-Fight", nameHe: "קרב עיוור", source: "Fifth Edition Feats",
    prerequisite: "WIS 13+, בקיאות בתפיסה", requirements: { minAbility: { wis: 13 } },
    description: "כל עוד אתה שומע יריב — הוא לא מקבל advantage עליך ואתה לא סובל disadvantage · בדיקת תפיסה לאיתור יעדים עד 30ft ללא ראייה." },
  { id: "tpk_catch_off_guard", name: "Catch Off-Guard", nameHe: "תפיסה לא מוכנה", source: "Fifth Edition Feats",
    description: "אין disadvantage עם נשק מאולתר · advantage נגד יריבים לא חמושים · המכה הראשונה בנשק מאולתר מפתיע — advantage." },
  { id: "tpk_channel_smite", name: "Channel Smite", nameHe: "מכת תיעול", source: "Fifth Edition Feats",
    prerequisite: "Channel Divinity או Lay on Hands",
    description: "Bonus action — נצל Channel Divinity: 2d6 נזק radiant לאל-מת (או necrotic ליצור חי אם אתה רשע) · אפשר לשפוך נזק radiant מ-Lay on Hands עד גובה הרמה שלך." },
  { id: "tpk_charging_expertise", name: "Charging Expertise", nameHe: "מומחיות הסתערות", source: "Fifth Edition Feats",
    description: "אחרי Dash — bonus action להתקפת מגע או Shove · תנועה של 10ft בקו ישר מעניקה +5 נזק או דחיפה 10ft · אין advantage נגדך בסבב שבו הסתערת." },
  { id: "tpk_cleave", name: "Cleave", nameHe: "בקיעה", source: "Fifth Edition Feats",
    prerequisite: "STR 13+, Power Attack", requirements: { minAbility: { str: 13 } },
    description: "פגיעה מאפשרת התקפת בונוס ביעד סמוך · התנועה שלך נחצית באותו תור · ברמה 5 וכל 5 רמות — עוד יעד לבקיעה." },
  { id: "tpk_combat_caster", name: "Combat Caster", nameHe: "מטיל בקרב", source: "Fifth Edition Feats",
    requirements: { spellcasting: true },
    description: "Advantage על שמירת ריכוז בקרב · הטלה גם עם נשק/מגן ביד · Reaction להטיל קנטריפ במקום התקפת הזדמנות." },
  { id: "tpk_combat_expertise", name: "Combat Expertise", nameHe: "מומחיות קרב", source: "Fifth Edition Feats",
    prerequisite: "DEX 13+", requirements: { minAbility: { dex: 13 } },
    description: "+1 DEX · אפשר לקחת disadvantage על כל ההתקפות שלך כדי לכפות disadvantage על כל ההתקפות נגדך.",
    bonuses: { ability: [{ ability: "dex", amount: 1 }] } },
  { id: "tpk_combat_reflexes", name: "Combat Reflexes", nameHe: "רפלקסים בקרב", source: "Fifth Edition Feats",
    prerequisite: "DEX 13+", requirements: { minAbility: { dex: 13 } },
    description: "מספר התקפות הזדמנות בסבב = מקדם DEX (מינימום 1) · advantage על כל התקפות ההזדמנות." },
  { id: "tpk_command_undead", name: "Command Undead", nameHe: "פקידה על אל-מתים", source: "Fifth Edition Feats",
    prerequisite: "נטייה רעה, Channel Divinity",
    description: "Action — Channel Divinity משעבד אל-מתים בטווח 30ft שהיו נהרסים · שליטה בסך HD עד רמת הכהן שלך." },
  { id: "tpk_crossbow_expertise", name: "Crossbow Expertise", nameHe: "מומחיות קשת", source: "Fifth Edition Feats",
    prerequisite: "בקיאות בקשתות",
    description: "התעלמות מ-Loading · אין disadvantage בירי בטווח 5ft · hand crossbow טעונה ביד שנייה — ירייה כ-bonus action." },
  { id: "tpk_danger_sense", name: "Danger Sense", nameHe: "חוש סכנה", source: "Fifth Edition Feats",
    prerequisite: "WIS 13+, בקיאות בתובנה", requirements: { minAbility: { wis: 13 } },
    description: "+1 WIS · פעם ל-short rest advantage על יוזמה · advantage נגד אפקטים שלא ראית מגיעים.",
    bonuses: { ability: [{ ability: "wis", amount: 1 }] } },
  { id: "tpk_deceitful", name: "Deceitful", nameHe: "רמאי", source: "Fifth Edition Feats",
    prerequisite: "בקיאות בהטעיה",
    abilityChoice: { options: ["cha", "int"] },
    description: "+1 CHA או INT (לבחירתך) · Expertise בהטעיה · advantage בזיוף ותחפושת." },
  { id: "tpk_disorienting_blow", name: "Disorienting Blow", nameHe: "מכה מבלבלת", source: "Fifth Edition Feats",
    prerequisite: "STR 13+ או DEX 13+",
    description: "בפגיעה — היעד חייב CON save או שיסבול disadvantage בהתקפה הבאה שלו ולא יוכל להגיב עד סוף תורו." },
  { id: "tpk_elemental_focus", name: "Elemental Focus", nameHe: "מיקוד יסודי", source: "Fifth Edition Feats",
    prerequisite: "יכולת להטיל כישופי רמה 1+", requirements: { spellcasting: true },
    description: "בחר יסוד (חומצה/קור/חשמל/אש): +1 ל-DC של כל כישוף מהיסוד · פעם ל-long rest כפה disadvantage על ה-save." },
  { id: "tpk_endurance", name: "Endurance", nameHe: "סבולת", source: "Fifth Edition Feats",
    prerequisite: "CON 13+", requirements: { minAbility: { con: 13 } },
    description: "+1 CON · advantage נגד עייפות, רעב, צמא וקור/חום קיצוני.",
    bonuses: { ability: [{ ability: "con", amount: 1 }] } },
  { id: "tpk_extra_ki", name: "Extra Ki", nameHe: "קי נוסף", source: "Fifth Edition Feats",
    prerequisite: "Ki class feature", requirements: { class: ["monk"] },
    description: "מאגר ה-Ki שלך גדל ב-3 נקודות." },
  { id: "tpk_extra_lay_on_hands", name: "Extra Lay On Hands", nameHe: "סמיכת ידיים מוגברת", source: "Fifth Edition Feats",
    prerequisite: "Lay on Hands", requirements: { class: ["paladin"] },
    description: "מאגר ה-Lay on Hands מחושב כאילו רמת הפלאדין שלך גבוהה ב-3." },
  { id: "tpk_fight_on", name: "Fight On", nameHe: "ממשיך להילחם", source: "Fifth Edition Feats",
    prerequisite: "CON 13+", requirements: { minAbility: { con: 13 } },
    description: "פעם ל-long rest, Reaction — 1d8 + מקדם CON נקודות פגיעה זמניות לדקה, גם כשאתה עומד ליפול." },
  { id: "tpk_grappling_expertise", name: "Grappling Expertise", nameHe: "מומחיות אחיזה", source: "Fifth Edition Feats",
    prerequisite: "STR 13+", requirements: { minAbility: { str: 13 } },
    description: "advantage על התקפות נגד יעד שאתה אוחז · bonus action לניסיון pin · אין disadvantage בהתקפות בזמן אחיזה." },
  { id: "tpk_great_weapon_expertise", name: "Great Weapon Expertise", nameHe: "מומחיות נשק גדול", source: "Fifth Edition Feats",
    prerequisite: "STR 13+, נשק two-handed", requirements: { minAbility: { str: 13 } },
    description: "+1 STR · גלגול מחדש של 1 ו-2 בקוביות נזק של נשק דו-ידני · טווח קריט מוגדל ב-1 עם נשק כבד.",
    bonuses: { ability: [{ ability: "str", amount: 1 }] } },
  { id: "tpk_heavy_armor_proficiency", name: "Heavy Armor Proficiency", nameHe: "בקיאות בשריון כבד", source: "Fifth Edition Feats",
    prerequisite: "בקיאות בשריון בינוני", requirements: { armorProf: "medium" as any },
    description: "+1 STR · בקיאות בשריונות כבדים ללא קנס.",
    bonuses: { ability: [{ ability: "str", amount: 1 }] } },
  { id: "tpk_heroic_defiance", name: "Heroic Defiance", nameHe: "התרסה הרואית", source: "Fifth Edition Feats",
    prerequisite: "CON 13+", requirements: { minAbility: { con: 13 } },
    description: "פעם ל-long rest — דחה אפקט שדורש ממך saving throw לסוף התור הבא שלך." },
  { id: "tpk_iron_will", name: "Iron Will", nameHe: "רצון ברזל", source: "Fifth Edition Feats",
    prerequisite: "WIS 13+", requirements: { minAbility: { wis: 13 } },
    abilityChoice: { options: ["wis", "cha"] },
    description: "+1 WIS או CHA (לבחירתך) · +2 ל-saving throws של WIS · פעם ל-long rest גלגול מחדש של save נפשי." },
  { id: "tpk_ironskin", name: "Ironskin", nameHe: "עור ברזל", source: "Fifth Edition Feats",
    prerequisite: "CON 13+", requirements: { minAbility: { con: 13 } },
    description: "+1 CON · +1 AC כשאינך לובש שריון כבד.",
    bonuses: { ability: [{ ability: "con", amount: 1 }], acBonus: 1 } },
  { id: "tpk_lookout", name: "Lookout", nameHe: "צופה", source: "Fifth Edition Feats",
    prerequisite: "בקיאות בתפיסה",
    description: "+1 WIS · בני הברית בטווח 30ft לא מופתעים אם אתה לא מופתע · +2 ליוזמה שלך ושל בן ברית סמוך.",
    bonuses: { ability: [{ ability: "wis", amount: 1 }] } },
  { id: "tpk_lycanthrope_slayer", name: "Lycanthrope Slayer", nameHe: "צייד ליקנתרופים", source: "Fifth Edition Feats",
    description: "advantage על התקפות נגד משני-צורה · הנשקים שלך מתגברים על עמידות ליקנתרופים לנזק לא-קסום." },
  { id: "tpk_magical_aptitude", name: "Magical Aptitude", nameHe: "כישרון קסום", source: "Fifth Edition Feats",
    prerequisite: "יכולת הטלת כישופים", requirements: { spellcasting: true },
    abilityChoice: { options: ["int", "wis", "cha"] },
    description: "+1 INT/WIS/CHA (לבחירתך) · Expertise בתורת הנסתר · advantage בזיהוי כישופים ופריטים קסומים." },
  { id: "tpk_manyshot", name: "Manyshot", nameHe: "ירי מרובה", source: "Fifth Edition Feats",
    prerequisite: "DEX 13+, בקיאות בקשת", requirements: { minAbility: { dex: 13 } },
    description: "ירה שני חיצים בהתקפה אחת נגד אותו יעד — הנזק של החץ השני ללא מקדם היכולת." },
  { id: "tpk_penetrating_strike", name: "Penetrating Strike", nameHe: "מכה חודרת", source: "Fifth Edition Feats",
    prerequisite: "STR 13+ או DEX 13+",
    description: "התקפות הנשק שלך מתעלמות מ-3 נקודות עמידות/הפחתת נזק, ומתגברות על עמידות לנשק לא-קסום." },
  { id: "tpk_persistent_spell", name: "Persistent Spell", nameHe: "כישוף מתמיד", source: "Fifth Edition Feats",
    prerequisite: "יכולת להטיל כישופי רמה 3+", requirements: { spellcasting: true },
    description: "העלה את רמת ה-slot ב-2 — היעד מגלגל את ה-save פעמיים ולוקח את התוצאה הנמוכה." },
  { id: "tpk_physician", name: "Physician", nameHe: "רופא", source: "Fifth Edition Feats",
    prerequisite: "בקיאות ברפואה",
    description: "+1 WIS · Expertise ברפואה · ייצוב יצור כ-bonus action · טיפול מחזיר 1d6 + מקדם WIS.",
    bonuses: { ability: [{ ability: "wis", amount: 1 }] } },
  { id: "tpk_power_attack", name: "Power Attack", nameHe: "מכת עוצמה", source: "Fifth Edition Feats",
    prerequisite: "STR 13+", requirements: { minAbility: { str: 13 } },
    description: "+1 STR · הקרב עד -5 להתקפה תמורת +10 נזק בהתקפות מגע.",
    bonuses: { ability: [{ ability: "str", amount: 1 }] } },
  { id: "tpk_savage_warrior", name: "Savage Warrior", nameHe: "לוחם פראי", source: "Fifth Edition Feats",
    prerequisite: "STR 13+", requirements: { minAbility: { str: 13 } },
    abilityChoice: { options: ["str", "con"] },
    description: "+1 STR או CON (לבחירתך) · גלגול מחדש של 1 בנזק · פעם ל-short rest התקפה נוספת בזמן זעם/הסתערות." },
  { id: "tpk_selective_spell", name: "Selective Spell", nameHe: "כישוף סלקטיבי", source: "Fifth Edition Feats",
    prerequisite: "יכולת להטיל כישופי אזור", requirements: { spellcasting: true },
    description: "העלה את רמת ה-slot ב-1 — עד מקדם היכולת המטילה יצורים באזור אינם מושפעים כלל." },
  { id: "tpk_sharp_shot", name: "Sharp Shot", nameHe: "ירייה חדה", source: "Fifth Edition Feats",
    prerequisite: "DEX 13+", requirements: { minAbility: { dex: 13 } },
    description: "+1 DEX · התעלמות מחצי-מחסה · הקרב עד -5 להתקפה תמורת +10 נזק בירי.",
    bonuses: { ability: [{ ability: "dex", amount: 1 }] } },
  { id: "tpk_spirited_charge", name: "Spirited Charge", nameHe: "הסתערות רכובה", source: "Fifth Edition Feats",
    prerequisite: "בקיאות ברכיבה",
    description: "בהסתערות רכובה — נזק כפול בנשק מגע · advantage על Shove רכוב." },
  { id: "tpk_toppling_spell", name: "Toppling Spell", nameHe: "כישוף מפיל", source: "Fifth Edition Feats",
    requirements: { spellcasting: true },
    description: "כישוף שגורם נזק יכול להפיל את היעד (STR save) — עלות slot גבוהה ברמה אחת." },
  { id: "tpk_toughness", name: "Toughness", nameHe: "קשיחות", source: "Fifth Edition Feats",
    description: "+2 נקודות פגיעה לכל רמה (כולל רמות עבר).",
    bonuses: { hpPerLevel: 2 } },
  { id: "tpk_two_weapon_fighter", name: "Two-Weapon Fighter", nameHe: "לוחם שני נשקים", source: "Fifth Edition Feats",
    prerequisite: "DEX 13+", requirements: { minAbility: { dex: 13 } },
    description: "+1 DEX · הוסף מקדם יכולת לנזק היד השנייה · +1 AC כשאתה אוחז שני נשקים.",
    bonuses: { ability: [{ ability: "dex", amount: 1 }], acBonus: 1 } },
  { id: "tpk_weapon_expert", name: "Weapon Expert", nameHe: "מומחה נשק", source: "Fifth Edition Feats",
    abilityChoice: { options: ["str", "dex"] },
    description: "+1 STR או DEX (לבחירתך) · בחר סוג נשק אחד: +1 להתקפה ולנזק איתו." },
  { id: "tpk_widen_spell", name: "Widen Spell", nameHe: "כישוף מורחב", source: "Fifth Edition Feats",
    requirements: { spellcasting: true },
    description: "העלה את רמת ה-slot ב-1 — אזור ההשפעה של הכישוף גדל ב-50%." },
  { id: "tpk_laying_waste", name: "Laying Waste", nameHe: "השחתה", source: "Fifth Edition Feats",
    prerequisite: "STR 13+ או DEX 13+",
    description: "בקריט — הוסף קוביית נזק אחת מהנשק, והיעד מדמם 1d4 בתחילת תורו עד לריפוי." },
];
