...
export const CLASSES: DnDClass[] = [
  ...
  },
  {
    ...
    subclasses: [
      ...
      { id: "spores", name: "Circle of Spores", nameHe: "מעגל הנבגים", grantedSpells: [{ level: 3, spellIds: ["chill_touch", "blindness_deafness"] }, { level: 5, spellIds: ["animate_dead", "gentle_repose" ] }, { level: 7, spellIds: ["blight"] }, { level: 9, spellIds: ["summon_undead"] }], features: [{ level: 2, name: "Halo of Spores", desc: "" }] },
