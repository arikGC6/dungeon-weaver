...
export const CLASSES: DnDClass[] = [
  ...
  },
  {
    ...
    subclassLevel: 1,
    subclasses: [
      { id: "life", name: "Life Domain", nameHe: "תחום החיים", grantedSpells: [{ level: 1, spellIds: ["bless", "cure_wounds"] }, { level: 3, spellIds: ["lesser_restoration", "spiritual_weapon"] }], features: [{ level: 1, name: "Disciple of Life", desc: "+2+level לריפוי." }] },
      { id: "light", name: "Light Domain", nameHe: "תחום האור", grantedSpells: [{ level: 1, spellIds: ["burning_hands", "faerie_fire"] }, { level: 3, spellIds: ["flaming_sphere", "scorching_ray"] }], features: [{ level: 1, name: "Warding Flare", desc: "Disadvantage להתקפה." }] },
      { id: "war", name: "War Domain", nameHe: "תחום המלחמה", grantedSpells: [{ level: 1, spellIds: ["divine_favor", "shield_of_faith"] }], features: [{ level: 1, name: "War Priest", desc: "Bonus attack." }] },
      { id: "knowledge", name: "Knowledge Domain", nameHe: "תחום הידע", grantedSpells: [{ level: 1, spellIds: ["command", "identify"] }], features: [{ level: 1, name: "Blessings of Knowledge", desc: "2 שפות + 2 מיומנויות." }] },
      { id: "nature", name: "Nature Domain", nameHe: "תחום הטבע", grantedSpells: [{ level: 1, spellIds: ["animal_friendship", "speak_with_animals"] }], features: [{ level: 1, name: "Acolyte of Nature", desc: "Druid cantrip + skill." }] },
      { id: "tempest", name: "Tempest Domain", nameHe: "תחום הסערה", grantedSpells: [{ level: 1, spellIds: ["fog_cloud", "thunderwave"] }], features: [{ level: 1, name: "Wrath of the Storm", desc: "Reaction — 2d8 lightning/thunder." }] },
      { id: "trickery", name: "Trickery Domain", nameHe: "תחום התעלול", grantedSpells: [{ level: 1, spellIds: ["charm_person", "disguise_self"] }], features: [{ level: 1, name: "Blessing of the Trickster", desc: "Advantage on Stealth." }] },
    ],
    features: [
      { level: 1, name: "Spellcasting", desc: "" },
  ...
  },
  {
    ...
    subclassLevel: 3,
    subclasses: [
      { id: "devotion", name: "Oath of Devotion", nameHe: "שבועת המסירות", grantedSpells: [{ level: 3, spellIds: ["protection_from_evil_and_good", "sanctuary"] }], features: [{ level: 3, name: "Sacred Weapon", desc: "" }] },
      { id: "ancients", name: "Oath of the Ancients", nameHe: "שבועת הקדמונים", grantedSpells: [{ level: 3, spellIds: ["ensnaring_strike", "speak_with_animals"] }], features: [{ level: 3, name: "Nature's Wrath", desc: "" }] },
      { id: "vengeance", name: "Oath of Vengeance", nameHe: "שבועת הנקמה", grantedSpells: [{ level: 3, spellIds: ["bane", "hunters_mark"] }], features: [{ level: 3, name: "Vow of Enmity", desc: "" }] },
      { id: "conquest", name: "Oath of Conquest", nameHe: "שבועת הכיבוש", grantedSpells: [{ level: 3, spellIds: ["armor_of_agathys", "command"] }], features: [{ level: 3, name: "Conquering Presence", desc: "" }] },
    ],
    features: [
